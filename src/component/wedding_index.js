...
function Carousel() {
  useEffect(() => {
    ...
    function createSnowflake() {
      ...
      snowflake.style.left = `${Math.random() * 300}vw`; // Vị trí ngẫu nhiên theo chiều ngang
      snowflake.style.animationDuration = `${Math.random() * 10 + 7}s`; // Thời gian rơi ngẫu nhiên (5-10s)
